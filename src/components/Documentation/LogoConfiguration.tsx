      ...
      <div className="p-6 rounded-md border mt-4 border-border dark:border-dark_border">
        ...
        <div className="py-4 px-3 rounded-md bg-black mt-8">
          <div className="text-sm text-gray-400">
            ...
            <p className="ms-3">
              src=&#x22;/footer/footer-logo-white.Screenshot_from_2025-11-17_00-56-19-removebg-preview.png&#x22;
            </p>
            ...
            <p className="ms-2">&#x3C;Image</p>
            <p className="ms-5">
              src=&#x22;/images/footer/footer-logo-white.Screenshot_from_2025-11-17_00-56-19-removebg-preview.png&#x22;
            </p>
